"""
TeamFlow EPMS — Seed Roles Management Command.

Seeds the database with system roles and default permissions.
...
class Command(BaseCommand):
    """Seed system roles and default permissions into the database."""
    ...
    def _seed_permissions(self):
        """Create all permission records from PERMISSION_DEFINITIONS."""
    ...
    def _seed_roles(self):
        """Create all system role records from SYSTEM_ROLES."""
    ...
    def _assign_default_permissions(self):
        """Assign default permissions to each role via RolePermission."""
